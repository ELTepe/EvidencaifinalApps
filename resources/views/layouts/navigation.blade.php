    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @guest
                    <a class="text-sm font-medium text-gray-600 hover:text-gray-900" href="{{ route('login') }}">Ingresar</a>
                    <a class="ms-4 rounded-md bg-emerald-700 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-800" href="{{ route('register') }}">Registro</a>
                @else
